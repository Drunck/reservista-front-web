...
export default function AdminPanelSideMenu() {
  ...
  return (
    <div className="fixed w-full max-w-80 h-[--admin-sidebar-height] overflow-x-hidden border-r">
        <div className="flex flex-col w-full p-4 gap-y-2">
          ...
          <Link href="/admin/dashboard/restaurants"
            className={
              clsx("w-full px-4 py-2 rounded-md flex flex-row gap-x-2 text-sm  items-center transition active:shadow",
                {
                  "text-white bg-[#18181b] hover:bg-[--dark-blue-1] shadow-sm": pathname === "/admin/dashboard/restaurants",
                  "text-black hover:bg-muted": pathname !== "/admin/dashboard/restaurants"
                }
              )
            }>
          ...
          <Link href="/admin/dashboard/users"
            className={
              clsx("w-full px-4 py-2 rounded-md flex flex-row gap-x-2 text-sm  items-center transition active:shadow",
                {
                  "text-white bg-[#18181b] hover:bg-[--dark-blue-1] shadow-sm": pathname === "/admin/dashboard/users",
                  "text-black hover:bg-muted": pathname !== "/admin/dashboard/users"
                }
              )
            }>
